...
export const objects: WorkItem[] = [
  // === Collaborations ===
  {
    ...
    images: [
      "/placeholders/tea-1.jpg",
      "/placeholders/tea-2.jpg",
      "/placeholders/tea-3.jpg",
      "/placeholders/tea-4.jpg",
    ],
    blurred: true,
    comingSoon: true,
  },
  {
    ...
    images: [
      "/placeholders/bedding-felins.jpg",
      "/placeholders/bedding-oiseaux.jpg",
    ],
  },
  {
    id: "gin",
