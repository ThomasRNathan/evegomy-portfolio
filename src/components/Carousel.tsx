  ...
  return (
    <div className="relative">
      <div
        ref={trackRef}
        className={cn(
          "flex h-[40vh] min-h-[260px] max-h-[420px] snap-x snap-mandatory items-stretch gap-3 overflow-x-auto scroll-smooth",
          "md:h-[44vh] md:max-h-[460px]",
      ...
      {!single ? (
        <>
          <button
            ...
            disabled={!canPrev}
            className={cn(
              "absolute left-3 top-1/2 z-10 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-ivory/90 text-ink shadow-sm backdrop-blur transition-opacity hover:bg-ivory",
          ...
          <button
            ...
            disabled={!canNext}
            className={cn(
              "absolute right-3 top-1/2 z-10 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-ivory/90 text-ink shadow-sm backdrop-blur transition-opacity hover:bg-ivory",
